      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-[#007FFF] flex items-center justify-center">
            <span className="text-white text-sm font-['SF_Pro:Bold',sans-serif]">$</span>
          </div>
          <div>
            <p className="text-base font-['SF_Pro:Bold',sans-serif] text-white">
              {transaction.amount} {transaction.asset}
            </p>
            <p className="text-xs font-['SF_Pro:Medium',sans-serif] text-[#6b7a8f]">
              {formatDate(transaction.timestamp)}
            </p>
          </div>
        </div>
        <div className={`px-3 py-1 rounded-full ${statusBgColors[transaction.status]}`}>
          <p className={`text-xs font-['SF_Pro:Bold',sans-serif] capitalize ${statusColors[transaction.status]}`}>
            {transaction.status}
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 bg-[#1c2333] rounded-lg p-2">
        <div className="flex items-center gap-1.5">
          <div className="w-5 h-5 rounded-full bg-[#2D374B] flex items-center justify-center">
            <span className="text-white text-[10px] font-['SF_Pro:Medium',sans-serif]">A</span>
          </div>
          <span className="text-xs font-['SF_Pro:Bold',sans-serif] text-[#9ca3af]">{transaction.fromNetwork}</span>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-['SF_Pro:Bold',sans-serif] text-[#9ca3af]">{transaction.toNetwork}</span>
        </div>
      </div>

      {/* To Address */}
      <div className="flex items-center justify-between text-xs">
        <span className="font-['SF_Pro:Medium',sans-serif] text-[#6b7a8f]">To</span>
        <span className="font-['SF_Pro:Bold',sans-serif] text-white">{transaction.toAddress}</span>
      </div>
    </motion.div>
  )
}
      ...
      <div className="absolute bg-[#0d1421] content-stretch flex h-[784.405px] items-start justify-center left-1/2 px-[24px] py-[32px] rounded-[40px] top-[66.6px] translate-x-[-50%] w-[393px]">
        <div className="basis-0 content-stretch flex flex-col gap-[21px] grow h-full items-start min-h-px min-w-px relative shrink-0">
          ...
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
            ...
            <p className="font-['SF_Pro:Bold',sans-serif] font-bold leading-[23.542px] text-white text-[20px] text-center">
              Transaction History
            </p>
          ...
          <div className="bg-[#131a29] border border-[#1e2a3d] rounded-2xl p-4 w-full">
            <div className="flex items-center justify-between">
              <p className="font-['SF_Pro:Medium',sans-serif] text-sm text-[#6b7a8f]">Total Transactions</p>
              <p className="font-['SF_Pro:Bold',sans-serif] text-2xl text-white">{transactions.length}</p>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto w-full space-y-3 pr-1">
            {transactions.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center space-y-2">
                ...
                <p className="font-['SF_Pro:Bold',sans-serif] text-white">No transactions yet</p>
                <p className="font-['SF_Pro:Medium',sans-serif] text-sm text-[#6b7a8f]">
