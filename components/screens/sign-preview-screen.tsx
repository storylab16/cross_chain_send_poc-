              ...
              <div className="relative shrink-0 w-full">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[16px] py-0 relative w-full">
                    <p className="font-semibold leading-[23.542px] relative shrink-0 text-white text-[14px] text-center text-nowrap">
                      Cross-chain send
                    </p>
                  </div>
                </div>
                    ...
                    <div className="flex flex-col items-end justify-center size-full">
                      <div className="rounded-t-[20px] content-stretch flex flex-col gap-[10px] items-end justify-center px-[20px] py-[24px] relative w-full">
                        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                          ...
                          <div className="flex flex-col font-semibold justify-center leading-[0] relative shrink-0 text-[48px] text-white text-nowrap text-right">
                            <p className="leading-[23.542px]">-{amount} USDC</p>
                          </div>
                        </div>
                        <div className="flex flex-col font-medium justify-center leading-[0] relative shrink-0 text-[#6b7a8f] text-[16px] text-right w-full">
                    ...
                    <div className="flex flex-col items-end justify-center size-full">
                      <div className="rounded-b-[20px] content-stretch flex flex-col gap-[10px] items-end justify-center p-[20px] relative w-full">
                        <div className="content-stretch flex h-[24px] items-center justify-between relative shrink-0 w-full">
                          <p className="font-bold leading-[23.542px] relative shrink-0 text-[14px] text-white text-center text-nowrap">
                            To
                          </p>
                        ...
                        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                          <div className="basis-0 content-stretch flex gap-[8px] grow items-center min-h-px min-w-px relative shrink-0">
                            <div className="basis-0 content-stretch flex gap-[8px] grow h-[22px] items-center min-h-px min-w-px relative shrink-0">
                              ...
                              <p className="font-medium leading-[22px] relative shrink-0 text-[14px] text-white text-center text-nowrap">
                                {toAddress}
                              </p>
                            </div>
          ...
          <div className="content-stretch flex flex-col gap-[20px] items-start justify-end relative shrink-0 w-full mt-auto">
            ...
            <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full">
              ...
              <div className="relative shrink-0 w-full">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between px-[8px] py-[2px] relative w-full">
                    <p className="font-medium leading-[23.542px] relative shrink-0 text-[#6b7a8f] text-[14px] text-center text-nowrap">
                      Sender
                    </p>
                    <p className="font-bold leading-[22px] relative shrink-0 text-white text-[14px]">alice.eth@arb</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between px-[8px] py-[2px] relative w-full">
                    ...
                    <div className="content-stretch flex gap-[2px] items-start justify-end leading-[22px] relative shrink-0 text-[14px] text-nowrap">
                      <p className="font-bold relative shrink-0 text-white">0.2343434 USDC</p>
                      <p className="font-medium relative shrink-0 text-[#6b7a8f] text-center">(${gasFeeUSD})</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative shrink-0 w-full">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between px-[8px] py-[2px] relative w-full">
                    ...
                    <div className="content-stretch flex gap-[2px] items-start justify-end leading-[22px] relative shrink-0 text-[14px] text-nowrap">
                      <p className="font-bold relative shrink-0 text-white">{fee} USDC</p>
                      <p className="font-medium relative shrink-0 text-[#6b7a8f] text-center">(${providerFeeUSD})</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative shrink-0 w-full">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between px-[8px] py-[2px] relative w-full">
                    ...
                    <p className="font-bold leading-[22px] relative shrink-0 text-[#6b7a8f] text-[14px]">
                      04/23/28 04:34:22
                    </p>
                  </div>
                </div>
              ...
              <div className="relative shrink-0 w-full">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between px-[8px] py-[2px] relative w-full">
                    <p className="font-bold leading-[23.542px] relative shrink-0 text-white text-[14px] text-center text-nowrap">
                      Total
                    </p>
                    <div className="content-stretch flex gap-[2px] items-start justify-end leading-[22px] relative shrink-0 text-[14px] text-nowrap">
                      <p className="font-bold relative shrink-0 text-white">
                        {totalMin} ~ {totalMax} USDC
                      </p>
                      <p className="font-medium relative shrink-0 text-[#6b7a8f] text-center">
            ...
            <div className="content-stretch flex gap-[3px] h-[52px] items-center relative shrink-0 w-full">
              <button
                onClick={onSign}
                className="w-full bg-[#007FFF] h-[52px] relative rounded-[100px] hover:bg-[#0070e0] transition-colors"
              >
                <div className="flex flex-row items-center justify-center size-full">
                  <p className="font-medium leading-[22px] text-[16px] text-white/90">Sign Once to Send</p>
                </div>
              </button>
            </div>
          </div>
