import svgPaths from "./svg-a48vjtqbjl";
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-0 relative w-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[23.542px] not-italic relative shrink-0 text-[#22221d] text-[14px] text-center text-nowrap">{`Authorise to cross-chain send `}</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="basis-0 content-stretch flex gap-[8px] grow h-[22px] items-center min-h-px min-w-px relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[22px] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap">Bob.eth@op</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex h-full items-center justify-end relative shrink-0">
      <p className="font-['SF_Compact:Semibold',sans-serif] font-[656.2] leading-[22px] relative shrink-0 text-[#22221d] text-[14px] text-nowrap">{`alice.eth@arb `}</p>
    </div>
  );
}
...
function Group11() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['SF_Compact:Semibold',sans-serif] font-[656.2] leading-[22px] ml-[56.5px] mt-0 relative text-[#22221d] text-[14px] text-center text-nowrap translate-x-[-50%]">{`Arbitrum `}</p>
      <Group10 />
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0">
      <p className="font-['SF_Compact:Medium',sans-serif] font-[556] leading-[23.542px] relative shrink-0 text-[#22221d] text-[14px] w-[125px]">{`Gas fee `}</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[2px] items-start justify-end leading-[22px] relative shrink-0 text-[14px] text-nowrap">
      <p className="font-['SF_Compact:Semibold',sans-serif] font-[656.2] relative shrink-0 text-[#22221d]">0.2343434 USDC</p>
...
function Frame23() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0">
      <p className="font-['SF_Compact:Medium',sans-serif] font-[556] leading-[23.542px] relative shrink-0 text-[#22221d] text-[14px] w-[125px]">{`Provider fee `}</p>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex gap-[2px] items-start justify-end leading-[22px] relative shrink-0 text-[14px]">
      <p className="font-['SF_Compact:Semibold',sans-serif] font-[656.2] relative shrink-0 text-[#22221d] text-nowrap">1 USDC</p>
      <p className="font-['SF_Compact:Medium',sans-serif] font-[556] relative shrink-0 text-[#8f8f8f] text-center w-[48px]">($0.99)</p>
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0">
      <p className="font-['SF_Compact:Medium',sans-serif] font-[556] leading-[23.542px] relative shrink-0 text-[#22221d] text-[14px] w-[125px]">Expiry time</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="content-stretch flex items-start justify-end relative shrink-0">
      <p className="font-['SF_Compact:Medium',sans-serif] font-[556] leading-[22px] relative shrink-0 text-[#8f8f8f] text-[14px] text-nowrap">04/23/28 04:34:22</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex h-full items-center relative shrink-0">
      <p className="font-['SF_Compact:Bold',sans-serif] font-[790] leading-[23.542px] relative shrink-0 text-[#22221d] text-[16px] w-[125px]">Total</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex gap-[2px] items-start justify-end leading-[22px] relative shrink-0 text-[14px] text-nowrap">
      <p className="font-['SF_Compact:Bold',sans-serif] font-[790] relative shrink-0 text-[#22221d]">{`10 ~ 12  USDC`}</p>
      <p className="font-['SF_Compact:Medium',sans-serif] font-[556] relative shrink-0 text-[#8f8f8f] text-center">($9.99 ~ 11.99)</p>
    </div>
  );
}
...
function Review() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0 w-full" data-name="review">
      <List2 />
      <List3 />
      <List4 />
      <List5 />
...
function Frame9() {
  return (
    <div className="absolute bg-white content-stretch flex h-[784.405px] items-start justify-center left-1/2 pb-[48px] pt-[40px] px-[32px] rounded-[40px] top-[66.6px] translate-x-[-50%] w-[393px]">
      <Frame10 />
    </div>
  );
}
