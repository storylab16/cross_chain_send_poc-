import svgPaths from "./svg-y935cz46yg";
...
function Group5() {
  return (
    <div className="absolute inset-[29.92%_38.39%_12.89%_21.95%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.93252 11.4369">
        <g id="Group">
          <path d={svgPaths.p253ebd00} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p1790fb00} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Eth() {
  return (
    <div className="overflow-clip relative shrink-0 size-[20px]" data-name="eth">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.0001 20">
        <g id="Group">
          <path d={svgPaths.pa7dfcf0} fill="var(--fill-0, black)" id="Vector" />
        </g>
      </svg>
      <LayerX />
    </div>
